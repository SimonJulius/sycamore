...
const LoanFriendsTabIcon = (props: SvgProps) => (
    <Svg
        width={35}
        height={35}
        ...
        {...props}
    >
        <Circle cx={18.109} cy={17.332} r={17.332} fill="#F6F7F7" />
        <G clipPath="url(#a)">
            <Path
                fill="currentColor"
            ...
            <Path
                fill="currentColor"
                d="M22.39 17.196a1.01 1.01 0 1 0 0-2.019 1.01 1.01 0 0 0 0 2.019Z"
            />
            <Path
                stroke="currentColor"
                strokeLinecap="round"
...
export default LoanFriendsTabIcon
